...
use PeekAndPoke\Component\Psi\Functions\Unary\TypeCheck\IsNotNumericString;
use PeekAndPoke\Component\Psi\Functions\Unary\TypeCheck\IsNumericString;
use PeekAndPoke\Component\Psi\Tests\Mocks\MockA;

/**
 * Test IsNumericString and IsNotNumericString
 *
 * @author Karsten J. Gerber <kontakt@karsten-gerber.de>
 */
class IsNumericStringIsNotNumericStringTest extends \PHPUnit_Framework_TestCase
{
    /**
     * @param $psiValue
