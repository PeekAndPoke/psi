...
class IsDateStringTest extends TestCase
{
    ...
    public function testIsDateString($psiValue, $expectedResult)
    {
        ...
        $subject = new \PeekAndPoke\Component\Psi\Functions\Unary\Matcher\IsDateString();
        $result  = $subject->__invoke($psiValue);
    ...
    public static function provide()
    {
        return [
            ...
            ['2015-01-01T12:00:00.000-10:00', true],
            ['2015-01-01T12:00:00Z', true],
            ['2015-01-01T12:00:00.1Z', true],
            ['2015-01-01T12:00:00.12Z', true],
            ['2015-01-01T12:00:00.123Z', true],
            ['2015-01-01T12:00:00.1234Z', true],
            ['2015-01-01T12:00:00.12345Z', true],
            ['2015-01-01T12:00:00.123456Z', true],
